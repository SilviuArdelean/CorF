...
class string_utils
{
 public:
	...
	static bool compare_case_sensitive(std::string strFirst, std::string strSecond)
	{
		#ifdef __linux__
	...
	static bool search_substring(const std::string& str, const std::string& sub_str, bool case_sensitive = true)
	{
		std::size_t pos = 0;
