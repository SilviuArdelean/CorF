...
int _tmain(int argc, _TCHAR* argv[]) {
  if (argc < 2) {
    cout << "Incomplete or too many parameters. Please add the .XML file path "
            "only and try again."
         << std::endl;
    return -1;
  }
  ...
  // Q4 - Which is the maximum call depth for each namedop? A namedop that does
  // not call another namedop has a call depth of 1.
